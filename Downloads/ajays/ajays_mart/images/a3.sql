...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2019 at 06:11 PM
...
(140, 'Comfort Fabric Conditioner', 'comfort.jpg', '400 ml', 6, 'comfort', 289, 8, 1000);
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;
